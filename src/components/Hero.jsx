...
const Hero = () => {
  return (
    <div className="relative overflow-hidden bg-white">
      <img className='z-1' src="http://naswasoko.co.ke/static/media/banner6.e80f5820ac319b7fcf74.jpg" alt="" />
      <div className='z-10 gap-[2%] py-[2%] grid grid-cols-2 md:grid-cols-6 justify-center bg-gray-50 bg-opacity-70 mx-[10%] '>
