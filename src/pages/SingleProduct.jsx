        ...
        <div>
            ...
            <div className="flex px-[5%] flex-col py-[2%]">
                <div className="flex flex-col gap-2 items-start ">
                    ...
                    {loading ? (
                        <div role="status" className="space-y-8 flex animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse">
                            <div className="flex gap-5 flex-col md:flex-row w-full md:w-1/2">
                            ...
                            <div className="w-full">
                                <div className="h-5 bg-gray-200 rounded-full dark:bg-gray-700 w-64 mb-4"></div>
                                <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[480px] mb-5"></div>
